...
// Menggunakan tipe dari React untuk mendapatkan semua props standar dari sebuah tombol,
// ex : 'onClick', 'disabled', 'type', dll.
...
const Button: React.FC<ButtonProps> = ({ children, ...props }) => {
  return (
    <button
      ...
      {...props} // Meneruskan semua props lain (misalnya, onClick) ke elemen tombol
    >
      {children}
    </button>
  );
